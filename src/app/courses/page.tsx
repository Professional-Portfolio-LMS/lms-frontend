...
export default function CoursePage() {
  // For demo purposes, we'll use a state for role. In a real app, this would come from auth context
    ...
    <div className="min-h-screen">
      ...
      {/* <div className="bg-gray-100 p-2 flex justify-center gap-4">
        ...
        <button 
          ...
          className={`px-4 py-2 rounded ${role === 'instructor' ? 'bg-blue-500 text-white' : 'bg-gray-200'}`}
        >
          Instructor View
        </button>
      </div> */}
